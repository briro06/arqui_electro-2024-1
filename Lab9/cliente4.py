...
if __name__ == '__main__':
    ...
    msg = {"comando": "sobrevoltaje", "modo": "","umbral":"180"}
    ...
    #Vamos a imprimir los tiempo de E/S que se obtiene en el cliente 4, ya que estamos enviando datos y tambien obtenemos un retorno es por ello que se considera
    #como una operación de entrada/salida a nuestro cliente 4 , para este expermiento se tomo en consideración 10 valores
    print("Los valores de los tiempos de ejecución para operción de entrada/salida para el cliente 4 en microsegundos es: \n")
    print(lista_E_S)
